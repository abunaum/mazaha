...
@section('content')
    ...
    <section class="section dashboard">
        <div class="row">
            <div class="col-lg-8">
                <form method="post" action="{{ route('agenda-tambah-progress') }}" enctype="multipart/form-data">
                    @csrf
...
@section('scripts')
    <script>
        ...
        judul.addEventListener('change', function () {
            fetch('{{ $url_panel.'/admin/agenda' }}/checkSlug?judul=' + judul.value)
